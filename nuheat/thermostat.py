...
class NuHeatThermostat(object):
    ...
    def get_data(self):
        ...
        data = self._session.request(
            self._session.config.thermostat_url, params=params)
    ...
    def schedule_mode(self, mode):
        ...
        :param mode: The desired mode integer value.
                     ...
                     Permanent hold = 3
        """
        modes = [const.SCHEDULE_RUN, const.SCHEDULE_TEMPORARY_HOLD, const.SCHEDULE_HOLD]
    ...
    def resume_schedule(self):
        ...
        """
        self.schedule_mode = const.SCHEDULE_RUN

    def set_target_fahrenheit(self, fahrenheit, mode=const.SCHEDULE_HOLD):
        """
    ...
    def set_target_celsius(self, celsius, mode=const.SCHEDULE_HOLD):
        """
    ...
    def set_target_temperature(self, temperature, mode=const.SCHEDULE_HOLD):
        """
        ...
        modes = [const.SCHEDULE_TEMPORARY_HOLD, const.SCHEDULE_HOLD]
        if mode not in modes:
            raise Exception("Invalid mode. Please use one of: {}".format(modes))
    ...
    def set_data(self, post_data):
        ...
        self._session.request(self._session.config.thermostat_url,
                              method="POST", data=post_data, params=params)
